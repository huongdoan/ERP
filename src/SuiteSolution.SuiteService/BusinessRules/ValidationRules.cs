...
namespace SuiteSolution.Service.BusinessRules
{
        ...
        public class ValidationRules
        {
            ...
            public Dictionary<string, string> ValidationErrors { get { return _validationErrors; } }
            ...
            public void UpdateMessages(Boolean validationStatus, List<String> validationMessages, Dictionary<string, string> validationErrors)
            {
